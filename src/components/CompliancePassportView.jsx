    ...
    return (
      <div style={{ backgroundColor: '#0b1a2d', minHeight: '80vh', padding: '2.5rem 1.5rem', color: '#ffffff' }}>
        ...
        <div className="terminal-stat-cards" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: '1.25rem', marginBottom: '2rem' }}>
          ...
          <div className="terminal-card" style={{ backgroundColor: '#0f2238', border: '1px solid #1e385b', borderRadius: '10px', padding: '1.25rem' }}>
            <span className="t-card-label" style={{ fontSize: '0.8rem', color: '#94a3b8', textTransform: 'uppercase' }}>QR Validity Period</span>
            <div style={{ display: 'flex', alignItems: 'baseline', justifyContent: 'space-between', marginTop: '0.4rem' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(440px, 1fr))', gap: '2rem', marginBottom: '2.5rem' }}>
          ...
          <div style={{ backgroundColor: '#0f2238', border: '1px solid #1e385b', borderRadius: '12px', padding: '1.75rem' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1.25rem', flexWrap: 'wrap', gap: '0.5rem' }}>
              <h3 style={{ margin: 0, fontSize: '1.25rem', display: 'flex', alignItems: 'center', gap: '0.5rem', color: '#ffffff' }}>
                <ShieldCheck size={22} color="#38bdf8" />
                <span>Statutory Document Verification</span>
              </h3>
              <span style={{ fontSize: '0.78rem', color: allVerified ? '#34d399' : '#38bdf8', fontWeight: '700', padding: '0.2rem 0.5rem', backgroundColor: '#081729', borderRadius: '4px', border: '1px solid #1e385b' }}>
              ...
              {STATUTORY_DOCUMENTS.map((doc) => {
                ...
                return (
                  <div
                    key={doc.type}
                    style={{
                      backgroundColor: isVerified ? 'rgba(16, 185, 129, 0.05)' : '#081729',
                      borderRadius: '8px',
                      border: isVerified ? '1px solid rgba(52, 211, 153, 0.35)' : '1px solid #1e385b',
                      padding: '0.9rem 1rem',
                      display: 'flex',
                  ...
                  >
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                      <div style={{ display: 'flex', alignItems: 'center', gap: '0.6rem' }}>
                        <FileText size={16} color={isVerified ? '#34d399' : '#38bdf8'} />
                      ...
                      {isVerified ? (
                        ...
                        <span style={{ display: 'flex', alignItems: 'center', gap: '0.35rem', color: '#ef4444', fontSize: '0.8rem', fontWeight: '700' }}>
                          <XCircle size={16} /> Mismatch
                        </span>
                      ) : isScanning ? (
                        <span style={{ display: 'flex', alignItems: 'center', gap: '0.35rem', color: '#38bdf8', fontSize: '0.8rem', fontWeight: '700' }}>
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '0.6rem', flexWrap: 'wrap' }}>
                      ...
                      <button
                        ...
                        style={{
                          ...
                          backgroundColor: fileObj ? 'rgba(56, 189, 248, 0.15)' : '#1e385b',
                          color: fileObj ? '#38bdf8' : '#e2e8f0',
                          border: fileObj ? '1px solid #38bdf8' : '1px solid #2b4c77',
                          borderRadius: '5px',
                          fontSize: '0.78rem',
                          fontWeight: '600',
                          cursor: 'pointer',
                      ...
                      <button
                        ...
                        style={{
                          ...
                          backgroundColor: isVerified ? 'rgba(16, 185, 129, 0.2)' : '#0284c7',
                    ...
                    {statusObj.statement && (
                      <div style={{
                        ...
                        fontSize: '0.76rem',
                        lineHeight: '1.4',
                        backgroundColor: isVerified ? 'rgba(16, 185, 129, 0.08)' : isFailed ? 'rgba(239, 68, 68, 0.08)' : 'rgba(56, 189, 248, 0.08)',
                        color: isVerified ? '#34d399' : isFailed ? '#ef4444' : '#38bdf8',
                        borderLeft: `3px solid ${isVerified ? '#10b981' : isFailed ? '#ef4444' : '#38bdf8'}`,
                        display: 'flex',
            ...
            <div style={{ display: 'flex', gap: '0.75rem', flexWrap: 'wrap' }}>
              ...
              <button
                ...
                style={{
                  ...
                  alignItems: 'center',
                  gap: '0.5rem',
                  boxShadow: canIssue ? '0 4px 12px rgba(16, 185, 129, 0.3)' : 'none'
                }}
              >
