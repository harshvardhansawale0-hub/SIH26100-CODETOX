      ...
      <div className="container-custom">
        ...
        <div style={{ marginBottom: '2rem', display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', flexWrap: 'wrap', gap: '1rem' }}>
          <div>
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', marginBottom: '0.4rem' }}>
              <span className="section-tag" style={{ margin: 0 }}>PROCUREMENT FORECAST & PIPELINE (GFR 144)</span>
        ...
        {activeTab === 'app' && (
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem', marginBottom: '3rem' }}>
            <div style={{ backgroundColor: '#0b1a2d', border: '1px solid #1e385b', borderRadius: '12px', padding: '1.25rem', display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: '1rem' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
                <PieChart size={24} color="#38bdf8" />
                <div>
                  <h3 style={{ fontSize: '1.1rem', color: '#ffffff', margin: '0 0 2px 0', fontWeight: '700' }}>
              ...
              <div style={{ display: 'flex', gap: '0.75rem' }}>
                <span style={{ fontSize: '0.78rem', backgroundColor: '#10b98120', color: '#10b981', border: '1px solid #10b981', padding: '4px 10px', borderRadius: '6px', fontWeight: '800' }}>
                  25% MSE Reserved
                </span>
                <span style={{ fontSize: '0.78rem', backgroundColor: '#ec489920', color: '#ec4899', border: '1px solid #ec4899', padding: '4px 10px', borderRadius: '6px', fontWeight: '800' }}>
                  3% Women-Owned
                </span>
                <span style={{ fontSize: '0.78rem', backgroundColor: '#f59e0b20', color: '#f59e0b', border: '1px solid #f59e0b', padding: '4px 10px', borderRadius: '6px', fontWeight: '800' }}>
                  50% MII Class-I
                </span>
              </div>
            </div>
                  ...
                  <div>
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '0.75rem' }}>
                      <div>
                        ...
                        <h3 style={{ fontSize: '1.25rem', color: '#ffffff', margin: '0.2rem 0', fontWeight: '800' }}>
                          {plan.ministry}
                        </h3>
                      </div>
                      <div style={{ textAlign: 'right' }}>
                        <span style={{ fontSize: '0.7rem', color: '#94a3b8', display: 'block' }}>Total Budget</span>
                        <span style={{ fontSize: '1.15rem', fontWeight: '900', color: '#10b981' }}>{plan.budget}</span>
                      </div>
                    </div>

                    <div style={{ backgroundColor: '#071526', border: '1px solid #1e385b', borderRadius: '8px', padding: '0.85rem', marginBottom: '1rem' }}>
                      ...
                      <div style={{ display: 'flex', flexWrap: 'wrap', gap: '0.4rem' }}>
                        {plan.categories.map((cat, cIdx) => (
                          <span key={cIdx} style={{ fontSize: '0.75rem', backgroundColor: '#0f2238', color: '#cbd5e1', border: '1px solid #1e385b', padding: '2px 8px', borderRadius: '4px' }}>
                            • {cat}
                          </span>
                        ))}
                      </div>
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '0.5rem', marginBottom: '1.25rem', fontSize: '0.78rem' }}>
                      <div style={{ backgroundColor: '#071526', padding: '0.5rem', borderRadius: '6px' }}>
                        <span style={{ color: '#94a3b8' }}>MSE 25% Quota:</span>
                        <div style={{ color: '#10b981', fontWeight: '700' }}>{plan.mseQuota}</div>
                      </div>
                      <div style={{ backgroundColor: '#071526', padding: '0.5rem', borderRadius: '6px' }}>
                        <span style={{ color: '#94a3b8' }}>Women SHG 3%:</span>
                        <div style={{ color: '#ec4899', fontWeight: '700' }}>{plan.womaniyaQuota}</div>
                      </div>
                    </div>
                  </div>
                ...
                >
                  <div style={{ flex: 1, minWidth: '280px' }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: '0.65rem', marginBottom: '0.4rem' }}>
                      <span className="mono-text" style={{ color: '#38bdf8', fontSize: '0.85rem', fontWeight: '800' }}>
                        {notice.id}
                      </span>
                      <span style={{ fontSize: '0.7rem', backgroundColor: 'rgba(245, 158, 11, 0.15)', color: '#f59e0b', padding: '2px 8px', borderRadius: '4px', fontWeight: '800' }}>
                        EXPECTED RFP: {notice.expectedPublishDate}
                      </span>
                    </div>

                    <h4 style={{ fontSize: '1.15rem', color: '#ffffff', margin: '0 0 0.35rem 0', fontWeight: '700' }}>
                      {notice.title}
                    </h4>
                    <span style={{ fontSize: '0.82rem', color: '#94a3b8', display: 'block', marginBottom: '0.65rem' }}>
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-end', gap: '0.75rem' }}>
                    <div style={{ textAlign: 'right' }}>
                      <span style={{ fontSize: '0.75rem', color: '#94a3b8', display: 'block' }}>Estimated Outlay</span>
                      <span style={{ fontSize: '1.25rem', fontWeight: '900', color: '#38bdf8' }}>{notice.estimatedValue}</span>
                    </div>
                    ...
                    <button
                      ...
                      style={{
                        backgroundColor: isRegistered ? '#10b98125' : '#38bdf8',
                        color: isRegistered ? '#10b981' : '#071526',
                        ...
                        alignItems: 'center',
                        gap: '0.4rem',
                        boxShadow: isRegistered ? 'none' : '0 4px 12px rgba(56, 189, 248, 0.3)'
                      }}
                    >
                      {isRegistered ? (
                        <>
        ...
        {activeTab === 'gte' && (
          <div style={{ backgroundColor: '#0b1a2d', border: '1px solid #1e385b', borderRadius: '12px', padding: '1.75rem', marginBottom: '3rem' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
              {[
                ...
                <div key={gIdx} style={{ backgroundColor: '#071526', border: '1px solid #1e385b', borderRadius: '8px', padding: '1rem', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                  <div>
                    <span className="mono-text" style={{ color: '#38bdf8', fontSize: '0.8rem', fontWeight: '700' }}>{gte.ref}</span>
                    <h4 style={{ margin: '2px 0', fontSize: '1rem', color: '#fff' }}>{gte.title}</h4>
                    <span style={{ fontSize: '0.8rem', color: '#94a3b8' }}>{gte.ministry}</span>
                  </div>
                  <div style={{ textAlign: 'right' }}>
                    <span style={{ fontSize: '1.1rem', fontWeight: '800', color: '#10b981' }}>{gte.val}</span>
                  </div>
                </div>
              ))}
            </div>
