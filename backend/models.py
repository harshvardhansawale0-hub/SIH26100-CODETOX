...
class BidVerifyRequest(BaseModel):
    ...
    tenderDocumentId: Optional[str] = Field(default=None, description="UUID of the uploaded tender document")
    gstDocumentId: Optional[str] = Field(default=None, description="UUID of the uploaded GST certificate")
    panDocumentId: Optional[str] = Field(default=None, description="UUID of the uploaded PAN card")
    udyamDocumentId: Optional[str] = Field(default=None, description="UUID of the uploaded Udyam/MSME certificate")
